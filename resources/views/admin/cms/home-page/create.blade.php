                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <form action="{{ route('admin.cms.ourservice.store') }}" method="POST">
                                        @csrf
                                        <input id="icon" name="icon" type="hidden" value="{{ old('icon') }}">

                                        <div class="row">
                                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                <label for="icon-picker" class="required">Pick the icon</label>
                                                <div id="target" data-icon="{{ old('icon') }}" data-name="icon"></div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" cols="30" rows="2" class="form-control required @error('description') border-danger @enderror">{{ old('description') }}</textarea>
                                                    @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
