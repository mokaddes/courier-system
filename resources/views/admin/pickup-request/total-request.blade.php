...
@section('total-for-delivery', 'active')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap jsgrid-table" id="dataTables">
                                    ...
                                    <tbody>
                                    @if (isset($pickup_requests) && count($pickup_requests) > 0)
                                        @foreach ($pickup_requests as $key => $row)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                ...
                                                <td>
                                                    @if (isset($row->merchant_id))
                                                        <a
                                                                href="{{ route('admin.merchant.show', ['id' => $row->merchant_id]) }}">{{ $row->hasMerchant->name ?? '' }}</a>
                                                    @else
                                                        Guest
                                                    @endif
