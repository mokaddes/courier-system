                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($data['pricingGroups'] as $pricingGroup)
                                                            <option value="{{ $pricingGroup->id }}"
                                                                @if (old('pricing_group_id') == $pricingGroup->id) selelect @endif>
                                                    ...
                                                    <select class="form-control @error('price_group') border-danger @enderror"
                                                        ...
                                                        @foreach ($data['weights'] as $value)
                                                            <option value="{{ $value->id }}"
                                                                @if (old('weight_id') == $value->id) selelect @endif>
                                                                {{ $value->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('weight_id')
                                            ...
                                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label required" for="order">Order Number</label>
                                                    <input class="form-control @error('order_id') border-danger @enderror"
                                                        id="order_id" name="order_id" type="number"
                                                        value="{{ old('order_id') }}" placeholder="Enter Order Number" required>
                                                    @error('order_id')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('inside_main_city_price') border-danger @enderror"
                                                        ...
                                                        value="{{ old('inside_main_city_price') }}" required>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('inter_city_price') border-danger @enderror"
                                                        ...
                                                        value="{{ old('inter_city_price') }}" required>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('status') border-danger @enderror"
                                                        ...
                                                        <option value="1"
                                                            @if (old('status') == '1') selected @endif selected>
                                                            Active</option>
                                                        <option value="0"
